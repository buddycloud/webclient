...
define(function(require) {
  ...
  describe('util/linkify', function() {
    it('should return the channels mentions inline as HTML anchors', function() {
      var mention1 = linkify('testing channel@domain.tld');
      var mention2 = linkify('testing channel@domain.tld testing');
      var mention3 = linkify('channel@domain.tld testing');
      var mention4 = linkify('testing channel@domain.tld channel@domain.tld');
      var mention5 = linkify('testing channel@domain.tld channel@domain.tld testing');
      var mention6 = linkify('channel@domain.tld channel@domain.tld testing');
      var mention7 = linkify('c%hannel@domain.tld');
      var mention8 = linkify('chan&nel@domain.tld');
      var mention9 = linkify('channel@domain-ww.tld');
      var mention10 = linkify('%channel@domain-ww.tld');
