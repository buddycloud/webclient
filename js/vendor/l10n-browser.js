...
define(['l10n'],
    function(l10n) {
      function localiseHTML(html, options) {
        // localise the HTML fragment in html, by looking for data-l10n attributes and replacing the tag's contents with the looked up string.
      ...
      function getLoader(options) {
        // return a resource loader function for l10n.
        var baseURL;
      ...
      return {
        // an object which l10n.js can use to get the resource loader, plus utilty functions.
        'getLoader': getLoader,
